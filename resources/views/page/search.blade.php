...
<div class="main wrap">
                  <div class="ts-row cf">
                     <div class="col-8 main-content cf">
                        <div class="breadcrumbs"><span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="{{asset('home')}}"><span itemprop="title">Home</span></a></span><span class="delim"><i class="fa fa-angle-right"></i></span><span class="current">Tìm kiếm</span></div>
                       
                        <div class="main-slider as-primary" data-animation="fade" data-autoplay="1" data-autoplay-interval="5000">
                           <div>
                              <a href="#">
                                 <img width="740" height="357" src="source/image/burberry-sx-khau-trang-1.jpg" class="attachment-motive-alt-slider size-motive-alt-slider wp-post-image" alt="" title=""sizes="(max-width: 740px) 100vw, 740px" style="height: 400px" />             
